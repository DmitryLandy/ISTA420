...
from sales.orders as o group by o.empid;
...
from sales.orders as o1
	inner join 
	(select o.empid, max(o.orderdate) as maxorderdate 
		from sales.orders as o group by o.empid) as o2
	on o1.orderdate = maxorderdate and o1.empid = o2.empid;
