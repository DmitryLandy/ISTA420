...
select o.orderid, o.orderdate, o.custid, o.empid from sales.orders as o where o.orderdate =
(select max(oo.orderdate) from sales.orders as oo);
...
select distinct o.empid from sales.orders as o where o.orderdate >= '2016-05-01');
